...
UPDATE_INTERVAL = 200  # default value was 200 (Stephane)
def parse_args():
...
def train(dataloader, cnn_model, rnn_model, batch_size, labels, optimizer, epoch, ixtoword, image_dir):
    ...
    cnn_model.train()
    rnn_model.train()
    print('after training cnn and rnn')
    s_total_loss0 = 0
    s_total_loss1 = 0
    w_total_loss0 = 0
    w_total_loss1 = 0
...
if __name__ == "__main__":
    ...
    cfg.WORKERS = 1
    cfg.TRAIN.SMOOTH.GAMMA1 = 1.0
    cfg.TRAIN.SMOOTH.GAMMA2 = 1.0
    ...
    try:
        ...
        #out_s_loss = open("history_s_losses.txt", "w")
        #out_w_loss = open("history_w_losses.txt", "w")
        ...
        #out_s_loss.write(s_losses)
        #out_w_loss.write(w_losses)
