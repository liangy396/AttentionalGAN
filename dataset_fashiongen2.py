...
class TextDataset(data.Dataset):
    def __init__(self, data_dir, split='train', base_size=64,
        ...
        print(split)
        print('check')
        #print(self.current_h5_file)

        # filter based on selected categories
        selected_categories = [b'TOPS', b'SWEATERS', b'SHIRTS', b'DRESSES']
        #selected_categories = [b'TOPS']
        self.filtered_image_indexes = self.filter_by_categories(selected_categories, split)

        #print(self.filtered_image_indexes)
	...
	#print(self.captions)
        ...
        #print(self.number_example) #for debugging
